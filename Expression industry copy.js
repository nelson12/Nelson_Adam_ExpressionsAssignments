...
var immunizations=prompt("Please enter the total number of patients being immunized");//declaring number of immunizations 
var medical= immunizations/(doctorsWorking*hoursWorking);
//equation to find shots per hour per doctor
alert("the total immunizations per doctor per hour is" +" "+medical+ " "+"shots");
//print to console shots per hour